...
public class DrawableUtils {
	 ...
	 * @param bottom
	 */
	public static void setDrawableSize(RadioButton radioButton,
	 ...
	 * @return
	 */
	public static StateListDrawable createCheckBoxSelector(
			Drawable normalState, Drawable checkedState, Drawable nocheckable) {
		StateListDrawable bg = new StateListDrawable();
		bg.addState(new int[] { android.R.attr.state_checked,
				android.R.attr.state_enabled }, checkedState);
		bg.addState(new int[] { android.R.attr.state_enabled }, normalState);
		bg.addState(new int[] {}, nocheckable);
		return bg;
	}
	 ...
	 *            可用状态的图片
	 */
	public static StateListDrawable createSelectSelector(Drawable normalState,
			Drawable selectedState) {
		StateListDrawable bg = new StateListDrawable();
		bg.addState(new int[] { android.R.attr.state_selected,
				android.R.attr.state_enabled }, selectedState);
		bg.addState(new int[] { android.R.attr.state_enabled }, normalState);
		bg.addState(new int[] {}, normalState);
		return bg;
	}
